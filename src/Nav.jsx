...
export function Nav() {
   ...
   // Rotas nas quais o menu deve ficar oculto
   const esconderMenu = ["/login", "/register"].includes(location.pathname);
   ...
   return (
      <div className="text-amber-600 font-semibold flex items-center justify-between px-8 md:px-32 w-full h-17 bg-white shadow-xs shadow-amber-600/50">
         ...
         {/* Renderiza o menu só se não estiver nas rotas de login ou register */}
         {!esconderMenu && (
